...
Atributos: produto -> código, nome, preço e taxa de IVA, número de unidades em armazém
           encomenda -> número de encomenda, a data em que foi realizada e um fornecedor único
           fornecedor -> nome, número de informação fiscal, endereço, número de fax, condições de pagamento e um código interno do tipo de fornecedor 
           tipo de fornecedor -> designação, código interno 
Relações: feitas em baixo
...
```
Grau e cardinalidade: 1. Encomenda contém produto 
                      Grau - binário
                      Cardinalidade - N:M (uma encomenda contém vários produtos e um produto pode estar em várias encomendas)

                      2. Fornecedor possui tipo de fornecedor
                      Grau - binário
                      Cardinalidade - N:1 (vários fornecedores podem ter o mesmo tipo e cada fornecedor tem apenas um tipo associado)

                      3. Fornecedor realiza encomenda 
                      Grau - binário
                      Cardinalidade - 1:N (um fornecedor pode realizar várias encomendas e uma encomenda é realizada apenas por um fornecedor)


Obrigatoriedade:     1. Uma encomenda contém obrigatoriamenre um ou mais produtos / Nem todos os produtos constam em encomendas -> Parcial
                     2. Um fornecedor tem obrigatoriamente um tipo associado / Um tipo de fornecedor pode existir sem fornecedores associados -> Parcial
                     3. Uma encomenda pertence sempre a um fornecedor / Nem todos os fornecedores podem ter encomendas -> Parcial
...
![ex_2_1!](ex2_1.png "Diagrama do Sistema de Gestão de Stocks de uma empresa")
...
![ex_2_2!](ex2_2.png "Diagrama do Sistema de Prescrição Eletrónica de Medicamentos")
...
![ex_2_3!](ex2_3.png "Diagrama de Gestão de Conferências")
...
![ex_2_4a!](ex2_4a.png "Diagrama do Sistema de Informação da Universidade")
...
![ex_2_4b!](ex2_4b.png "AnImage or PDF file")
