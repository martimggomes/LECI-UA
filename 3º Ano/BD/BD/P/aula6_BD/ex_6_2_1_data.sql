INSERT INTO EMPRESA.DEPARTMENT (Dname, Dnumber, Mgr_ssn, Mgr_start_date) VALUES 
...
INSERT INTO EMPRESA.EMPLOYEE (Fname, Minit, Lname, Ssn, Bdate, Address, Sex, Salary, Super_ssn, Dno) VALUES 
...
UPDATE EMPRESA.DEPARTMENT SET Mgr_ssn = '21312332' WHERE Dnumber = 1;
UPDATE EMPRESA.DEPARTMENT SET Mgr_ssn = '321233765' WHERE Dnumber = 2;
UPDATE EMPRESA.DEPARTMENT SET Mgr_ssn = '41124234' WHERE Dnumber = 3;
UPDATE EMPRESA.DEPARTMENT SET Mgr_ssn = '12652121' WHERE Dnumber = 4;


-- Localizações
INSERT INTO EMPRESA.DEPT_LOCATIONS (Dnumber, Dlocation) VALUES 
(2, 'Aveiro'),
(3, 'Coimbra');

-- Projetos
INSERT INTO EMPRESA.PROJECT (Pname, Pnumber, Plocation, Dnum) VALUES 
...
-- Works_on
INSERT INTO EMPRESA.WORKS_ON (Essn, Pno, Hours) VALUES 
('183623612', 1, 20.0),
('183623612', 3, 10.0),
('21312332', 1, 20.0),
('321233765', 1, 25.0),
...
-- Dependentes
INSERT INTO EMPRESA.DEPENDENT (Essn, Dependent_name, Sex, Bdate, Relationship) VALUES 
