...
-- enable	=>  Location: PIN_Y4,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- reset	=>  Location: PIN_W1,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \s_count~42_combout\ : std_logic;
...
SIGNAL \s_count[0]~41_combout\ : std_logic;
...
\s_count~42\ : cycloneive_lcell_comb
-- Equation(s):
-- \s_count~42_combout\ = (\enable~input_o\) # (\reset~input_o\)
...
PORT MAP (
	...
	sclr => \s_count[0]~41_combout\,
	ena => \s_count~42_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => s_count(1));
...
-- Equation(s):
-- \Equal0~7_combout\ = (!s_count(27) & (!s_count(29) & (!s_count(28) & !s_count(30))))
...
-- Equation(s):
-- \Equal0~6_combout\ = (!s_count(26) & (!s_count(24) & (!s_count(23) & !s_count(25))))
...
-- Equation(s):
-- \Equal0~8_combout\ = (\Equal0~7_combout\ & (!s_count(31) & (\Equal0~5_combout\ & \Equal0~6_combout\)))
...
-- Equation(s):
-- \Equal0~0_combout\ = (!s_count(6) & (!s_count(4) & (!s_count(5) & !s_count(3))))
...
-- Equation(s):
-- \Equal0~2_combout\ = (!s_count(14) & (!s_count(13) & (!s_count(12) & !s_count(11))))
...
-- Equation(s):
-- \Equal0~4_combout\ = (\Equal0~3_combout\ & (!s_count(16) & (!s_count(15) & \Equal0~2_combout\)))
...
-- Equation(s):
-- \Equal0~1_combout\ = (!s_count(8) & (!s_count(7) & (!s_count(10) & !s_count(9))))
...
-- Equation(s):
-- \Equal0~9_combout\ = (\Equal0~8_combout\ & (\Equal0~0_combout\ & (\Equal0~4_combout\ & \Equal0~1_combout\)))
...
-- Equation(s):
-- \s_count[0]~40_combout\ = (\enable~input_o\ & (!\reset~input_o\ & ((!s_count(1)) # (!s_count(2)))))
...
\s_count[0]~41\ : cycloneive_lcell_comb
-- Equation(s):
-- \s_count[0]~41_combout\ = (((!\start~input_o\ & !\Equal0~10_combout\)) # (!\s_count[0]~40_combout\)) # (!\Equal0~9_combout\)
...
PORT MAP (
	...
	datab => \s_count[0]~40_combout\,
	datac => \start~input_o\,
	datad => \Equal0~10_combout\,
	combout => \s_count[0]~41_combout\);
