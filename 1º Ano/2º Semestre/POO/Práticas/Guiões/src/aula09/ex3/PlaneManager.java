...
public class PlaneManager {
    ...
    public Plane getFastestPlane() {
        ...
        for (Plane plane : planes) {
            if (fastestPlane == null || plane.getVelocidadeMaxima() > fastestPlane.getVelocidadeMaxima()) {
                fastestPlane = plane;
            }
        }
        return fastestPlane;
    ...
    public void printAllPlanes(String type) {
        for (Plane plane : planes) {
            if (plane instanceof CommercialPlane && type.equals("comercial")) {
                System.out.println(plane);
            } else if (plane instanceof MilitaryPlane && type.equals("militar")) {
                System.out.println(plane);
            }
        }
    }
