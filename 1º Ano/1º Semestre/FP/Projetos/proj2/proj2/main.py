...
def categories_from_file():
    ...
    categories_path = "C:\\Users\\MARTIM\\Desktop\\Disciplinas\\FP\\proj2\\proj2\\categories.txt"
    categories_list = []
...
def display_attractions_info(attractions):
    ...
    if number_attractions_found == 0: 
        ...
        print(f"Consegui encontrar {number_attractions_found} atrações com base nos requesitos.\nDe que maneira é que gostarias que te ordenasse os resultados?")
